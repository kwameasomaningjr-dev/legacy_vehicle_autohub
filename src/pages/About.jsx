...
export default function About() {
  return (
    <div className="min-h-screen pt-24 pb-16 space-y-16">
      ...
      {/* Hero Header */}
      <div className="bg-gradient-to-b from-dark-800 to-dark-900 border-b border-white/5 py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <span className="text-xs font-bold text-brand-400 uppercase tracking-widest">Our Heritage & Mission</span>
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="bg-dark-800 p-4 rounded-2xl border border-white/10">
                <span className="text-2xl font-black text-brand-400 block">500+</span>
                <span className="text-xs text-slate-400 font-medium">Successful Rentals Managed</span>
              </div>
              <div className="bg-dark-800 p-4 rounded-2xl border border-white/10">
                <span className="text-2xl font-black text-emerald-400 block">16 Regions</span>
                <span className="text-xs text-slate-400 font-medium">Nationwide Travel Clearance</span>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-xs font-bold text-brand-400 uppercase tracking-wider">Quality Assurance</span>
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Safety, Maintenance & Sanitization</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <h3 className="text-base font-bold text-white">Full Comprehensive Insurance</h3>
            ...
            <div className="glass-card p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <h3 className="text-base font-bold text-white">Deep Sanitization & AC Service</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="glass-card p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <h3 className="text-base font-bold text-white">Certified Chauffeur Staff</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="bg-dark-800 p-6 sm:p-10 rounded-3xl border border-white/10 space-y-6">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl font-bold text-white">Rental Guidelines & Requirements</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-slate-300">
            
            <div className="space-y-3 bg-dark-900/60 p-5 rounded-2xl border border-white/5">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/10">
            <p className="text-xs text-slate-400">Have questions about specific travel routes or customized corporate terms?</p>
            <Link
              to="/contact"
              className="px-6 py-2.5 rounded-xl bg-brand-500 text-dark-900 font-extrabold text-xs hover:bg-brand-400 transition-colors"
            >
